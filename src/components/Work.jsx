...
export default function Work({ onSelectProject }) {
  ...
  return (
    <section id="work" className="snap-section relative flex flex-col justify-center px-4 sm:px-6 lg:px-8 bg-black text-white pt-16 pb-6">
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="mt-5 sm:mt-6 grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 items-start">
          ...
          >
            <div className="relative overflow-hidden rounded-lg bg-neutral-950 border border-neutral-800/80 transition-all duration-300 group-hover:border-neutral-700 group-hover:shadow-lg">
              <div className="w-full aspect-[16/10] max-h-[240px] sm:max-h-[270px] overflow-hidden bg-neutral-900">
                <img
            ...
            <div className="mt-2.5 flex items-start justify-between">
              ...
              <div className="hidden sm:flex gap-1">
                {projects[0].tags.map((tag) => (
                  <span key={tag} className="text-[8px] font-bold uppercase tracking-wider px-2 py-0.5 rounded bg-neutral-900 text-neutral-400 border border-neutral-800">
                    {tag}
                  </span>
                ))}
              </div>
          ...
          >
            <div className="relative overflow-hidden rounded-lg bg-neutral-950 border border-neutral-800/80 transition-all duration-300 group-hover:border-neutral-700 group-hover:shadow-lg">
              <div className="w-full aspect-[4/5] max-h-[240px] sm:max-h-[270px] overflow-hidden bg-neutral-900">
                <img
